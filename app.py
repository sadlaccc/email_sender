...
if uploaded_file is not None:
    try:
        ...
        # Allow both UTF-8 and fallback encodings
        try:
        ...
        if "email" not in recipients_df.columns:
            ...
            st.success("Recipients list loaded successfully.")
            st.dataframe(recipients_df.head(20))
            st.checkbox("Use first row as header", value=True, disabled=True)
